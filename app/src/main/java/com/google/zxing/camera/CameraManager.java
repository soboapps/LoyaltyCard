 ...
 * <br/>
 * 
 * This class encapsulates all the services of the camera and the app is the only class dealing with camera
 * 
...
public final class CameraManager {
	 ...
	 * 
	 * Two binding operation：<br/>
	 * 1：will handler With callbacks associated；<br/>
	 * 2：Camera with callbacks associated<br/>
	 * In summary，That function is when the camera preview screen will be ready for the call hander
	...
	public synchronized void requestPreviewFrame(Handler handler, int message) {
		...
		if (theCamera != null && previewing) {
			...
			// Binding camera callback function，When the preview screen will be ready for a callback Camera.PreviewCallback.onPreviewFrame
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			// The scanner frame set into a square
			int height = width;
	 ...
	 * Calculation results hardMin~hardMax between
	 * 
	 * @param resolution
	 * @param hardMin
	 * @param hardMax
