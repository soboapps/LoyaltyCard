 ...
 * <br/>
 *
 * Camera parameter settings class
 */
final class CameraConfigurationManager {
	...
	/**
	 * Calculate the most suitable size from the camera preview screen supports a resolution of
	 * 
	 * @param parameters
	...
	/**
	 * in supported Values find desired Values，Returns can not be found null
	 * 
